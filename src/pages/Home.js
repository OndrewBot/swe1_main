        ...
        <div class="container px-4 py-5" id="featured-3">
            ...
            <div class="row g-5 py-5 row-cols-1 row-cols-lg-2 d-inline-flex align-items-center justify-content-center">
                <div class="feature col">
                    <h3 class="fs-2 text-body-emphasis">Recipes</h3>
                ...
                <div class="feature col">
                    <h3 class="fs-2 text-body-emphasis">Shopping List</h3>
                ...
                <div class="feature col">
                    <h3 class="fs-2 text-body-emphasis">Ingredients</h3>
                ...
                <div class="feature col">
                    <h3 class="fs-2 text-body-emphasis">Kitchen Timer</h3>
